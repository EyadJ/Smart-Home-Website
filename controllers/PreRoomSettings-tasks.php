<?php
	...
	echo"<form method='post' action='../controllers/CreateNewTask.php'>
	...
	echo"<tr><td>Task Name <input type='text' name='TaskName' placeholder='This field is Optional'/></td><td rowspan='3'>";
		...
		{
			echo"<table>
			<tr><td><label>Don't Change<input type='radio' name='$row[DeviceID]' value='2' checked/></label></td>
		...
		";
				...
				echo "<tr><th colspan='3'><input type='submit' value='Create' />
				</th></tr></table>
				</form>
				";
